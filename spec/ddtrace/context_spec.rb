...
RSpec.describe Datadog::Context do
  ...
  describe '#close_span' do
    ...
    def new_span(name = nil)
      Datadog::SpanOperation.new(
        Datadog::Span.new(name || double('name'))
      )
    end
